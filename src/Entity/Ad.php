 ...
 * @UniqueEntity(
 *     fields = {"title"},
 *     message = "Une autre annonce possède déjà ce titre, merce de le modifier"
 * )
 */
class Ad
{
     ...
     *      min = 40,
     *      max = 250,
     *      minMessage = "Le prix par nuit doit être supérieur à {{ limit }} euros",
     *      maxMessage = "Le prix par nuit doit être inférieur à {{ limit }} euros"
     * )
     */
    private $price;
    ...
    public function getAvgRatings(){
        ...
        if(count($this->comments)) {
            return $mean = $sum / count($this->comments);
        }
